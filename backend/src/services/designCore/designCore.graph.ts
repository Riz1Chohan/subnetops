...
function buildSummary(params: {
  ...
  return {
    ...
    notes: [
      "Phase 28 converts the backend object model into a connected design graph so devices, interfaces, links, zones, route domains, route intents, segmentation expectations, policies, NAT, DHCP, reservations, VLANs, and subnets can be inspected as relationships instead of loose tables.",
