...
const VENDOR_NEUTRAL_SAFETY_NOTICE =
  "Phase 42 templates are vendor-neutral implementation guidance only. They intentionally do not contain Cisco, Palo Alto, Fortinet, Juniper, Aruba, Linux, cloud, or any other platform command syntax.";
...
function createTemplate(
  ...
  return {
    ...
    commandGenerationReason: "Phase 42 intentionally stops at vendor-neutral execution templates. Platform-specific commands belong to a later gated phase after template truth is proven.",
    variableIds: [
  ...
  return {
    summary: {
      ...
      notes: [
        ...
        "No template is allowed to contain platform-specific command syntax in Phase 42.",
      ],
    },
