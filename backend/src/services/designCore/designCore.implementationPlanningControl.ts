...
export function buildV1ImplementationPlanningControl(params: { networkObjectModel: NetworkObjectModel; V1NetworkObjectModel?: unknown; V1DesignGraph?: V1DesignGraphControlSummary; V1RoutingSegmentation?: V1RoutingSegmentationControlSummary; V1SecurityPolicyFlow?: V1SecurityPolicyFlowControlSummary; }): V1ImplementationPlanningControlSummary {
  ...
  const overallReadiness: V1ImplementationReadiness = blockedStepGateCount ? "BLOCKED" : reviewStepGateCount ? "REVIEW_REQUIRED" : "READY";
