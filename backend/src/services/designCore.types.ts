...
export type V1StandardsApplicabilityState = "APPLICABLE" | "NOT_APPLICABLE" | "REVIEW_REQUIRED" | "UNSUPPORTED";
...
export interface V1StandardsRuleRow {
  ...
  authority: StandardsRule["authority"];
  strength: StandardsRule["strength"];
  applicabilityState: V1StandardsApplicabilityState;
...
export interface NetworkInterface extends V1NetworkObjectProvenanceFields {
  ...
  /** V1 compile compatibility: older proof code reads a human purpose field when present. */
  purpose?: string;
  truthState: NetworkObjectTruthState;
  vlanId?: number;
  subnetCidr?: string;
...
export interface NetworkLink extends V1NetworkObjectProvenanceFields {
  ...
  /** V1 compile compatibility: legacy scenario proof checks may classify by linkType. */
  linkType?: string;
  truthState: NetworkObjectTruthState;
...
export interface V1EngineProofRow {
...
export interface V1FinalProofPassControlSummary {
  ...
  engineProofRows: V1EngineProofRow[];
