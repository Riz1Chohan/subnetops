...
} from "./requirementsImpactRegistry.js";

export const REQUIREMENTS_MATERIALIZATION_POLICY_CONTRACT_VERSION = "PHASE2_REQUIREMENTS_MATERIALIZATION_POLICY_CONTRACT" as const;
...
export function buildRequirementMaterializationPolicySummary(
  ...
  return {
    ...
    fieldOutcomes,
    notes: [
      "Phase 2 requires every saved requirement field to become a materialized object, backend engine input signal, validation blocker, review item, explicit no-op, or unsupported item.",
