...
import { buildPhase17PlatformBomFoundationControl, PHASE17_PLATFORM_BOM_FOUNDATION_CONTRACT } from "../services/designCore/designCore.phase17PlatformBomFoundationControl.js";
...
assert(result.findings.some((finding) => finding.code === "PHASE17_ADVISORY_BOM_NOT_VENDOR_CATALOG"));
console.log("[phase17] Platform/BOM foundation selftest passed");
