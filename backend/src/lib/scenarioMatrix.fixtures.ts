...
export type V1ScenarioRiskClass = "baseline" | "security" | "routing" | "addressing" | "implementation" | "known-gap";
export type V1ExpectedReadiness = "ready" | "review" | "blocked" | "unknown";

export interface V1ScenarioExpectation {
  readinessOneOf: V1ExpectedReadiness[];
...
export interface V1ScenarioFixture {
  id: string;
  name: string;
  riskClass: V1ScenarioRiskClass;
  intent: string;
  project: unknown;
  expected: V1ScenarioExpectation;
  knownGaps: string[];
}
...
export const V1_SCENARIOS: V1ScenarioFixture[] = [
  {
  ...
  },
  {
    ...
    project: project({
      id: "V1-enterprise",
      name: "V1 Multi-Site Guest DMZ Enterprise",
  ...
  },
  {
    ...
    project: project({
      id: "V1-overlap-sites",
      name: "V1 Overlapping Site Blocks",
  ...
  },
  {
    ...
    project: project({
      id: "V1-public-range",
      name: "V1 Public Range Standards Blocker",
  ...
  },
  {
    ...
    project: project({
      id: "V1-invalid-gateways",
      name: "V1 Invalid Gateways",
  ...
  },
  {
    ...
    project: project({
      id: "V1-exhausted-site",
      name: "V1 Exhausted Site Block",
  ...
  },
  {
    ...
    project: project({
      id: "V1-empty-site",
      name: "V1 Empty Site Topology Incomplete",
  ...
  },
  {
    ...
    project: project({
      id: "V1-dhcp-overlap",
      name: "V1 DHCP Overlap Regression Gap",
