...
export const PHASE0_ENGINE_INVENTORY: Phase0EngineInventoryRow[] = [
  ...
  },
  {
    ...
    inputs: ["Project basePrivateRange", "Site defaultAddressBlock", "VLAN subnet/gateway/host demand", "requirement-derived segment demand"],
    outputs: ["organizationBlock", "siteBlocks", "addressingRows", "proposedRows", "transitPlan", "loopbackPlan", "CIDR/gateway/capacity findings"],
    ...
    testsSelftestsProvingIt: ["backend/src/lib/cidr.selftest.ts", "backend/src/lib/cidrProof.selftest.ts", "backend/src/lib/addressAllocator.selftest.ts", "backend/src/lib/cidrBoundary.selftest.ts"],
    propagationContract: REQUIRED_CONTRACT,
    currentPhase0Verdict: "NEEDS_PHASE_REPAIR",
  },
  {
