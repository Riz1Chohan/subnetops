...
import { canonicalCidr, cidrsOverlap, classifySegmentRole, containsIp, describeRange, describeSubnet, isBroadcastAddress, isNetworkAddress, isValidIpv4, parseCidr, recommendedPrefixForHosts, suggestedGatewayPattern, usableHostCount, } from "../lib/cidr.js";
...
export async function getValidationResults(projectId) {
    return prisma.validationResult.findMany({
        where: { projectId },
        orderBy: [{ severity: "asc" }, { createdAt: "desc" }],
    });
