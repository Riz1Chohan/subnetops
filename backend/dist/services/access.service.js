...
export async function getMembershipRole(userId, organizationId) {
    if (!organizationId)
        return null;
...
export async function ensureCanViewProject(userId, projectId) {
...
export async function ensureCanEditProject(userId, projectId) {
...
export async function ensureCanCommentOnProject(userId, projectId) {
    return ensureCanViewProject(userId, projectId);
}
export async function ensureOrganizationAssignable(userId, organizationId) {
    if (!organizationId)
        return null;
