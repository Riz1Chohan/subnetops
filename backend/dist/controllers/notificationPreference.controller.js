...
export async function updatePreferences(req, res) {
    ...
    const allowed = {};
    const booleanKeys = ["inAppInvites", "inAppMentions", "emailInvites", "emailMentions", "overdueReminders", "emailDigests"];
    ...
    const preferences = await service.updatePreferences(userId, allowed);
    res.json(preferences);
}
