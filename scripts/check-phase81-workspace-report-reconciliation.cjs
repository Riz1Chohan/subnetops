...
assertIncludes('backend/src/services/exportDesignCoreReport.service.ts', 'Phase 81 Requirement Output and Implementation Readiness Reconciliation', 'Report export must include Phase 81 reconciliation section');
