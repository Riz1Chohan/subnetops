...
assert(/^0\.(98|99|1[0-9]{2})\.0$/.test(pkg.version), 'root package version must be 0.98.0 or later Phase 100 compatible version');
...
assert(/version:\s*"0\.(98|99|1[0-9]{2})\.0"/.test(runtime), 'runtime version not advanced to 0.98.0 or later Phase 100 compatible version');
