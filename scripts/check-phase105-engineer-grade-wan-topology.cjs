...
assert(pkg.version === '0.105.0', 'package version must be 0.105.0');
...
assert(canvas.includes('branches.length >= 8 ? 5 : 4'), '10-site enterprise layout must use compact 5-column branch grid');
