...
assert(/^0\.(100|101|102|103|104|105|1[1-9][0-9])\.0$/.test(pkg.version), 'root package version must be 0.100.0 or later Phase 100 compatible version');
...
assert(/version: \"0\.(100|101|102|103|104|105|1[1-9][0-9])\.0\"/.test(runtime), 'runtime version not advanced to 0.100.0 or later');
