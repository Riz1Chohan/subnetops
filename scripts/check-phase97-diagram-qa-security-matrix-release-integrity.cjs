...
assert(runtime.includes('version: "0.97.0"'), "runtime version was not advanced to 0.97.0");
...
assert(pkg.includes('"version": "0.97.0"'), "root package version not advanced to 0.97.0");
