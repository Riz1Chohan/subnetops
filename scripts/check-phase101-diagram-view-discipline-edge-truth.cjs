...
assert(/^0\.(101|102|103|104|105)\.0$/.test(pkg.version), 'root package version must be 0.101.0 or later compatible release version');
...
assert(/version: \"0\.(101|102|103|104|105)\.0\"/.test(runtime), 'runtime version not advanced to a compatible Phase 101+ version');
