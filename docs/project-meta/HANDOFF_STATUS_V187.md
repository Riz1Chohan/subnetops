...
- The app is stronger and more honest, but the shared model still relies on inference in places where future versions should create more explicit explicit design objects earlier in the planner.
...
2. Continue converging the diagram engine onto the same trusted topology and flow model.
