        ...
        <div className="grid-2" style={{ alignItems: "start" }}>
          <div className="panel diagram-foundation-card">
            ...
            <div className="diagram-foundation-metrics">
              ...
              <div><span>WAN</span><strong>{synthesized.topology.topologyType === "collapsed-core" ? "local only" : synthesized.topology.internetBreakout === "centralized" ? "centralized WAN / breakout" : "distributed WAN / breakout"}</strong></div>
              <div><span>Cloud</span><strong>{synthesized.topology.cloudConnected ? (requirementsProfile.cloudProvider || "Connected cloud") : "Not attached"}</strong></div>
