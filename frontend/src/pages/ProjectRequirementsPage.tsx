...
export function ProjectRequirementsPage() {
  ...
  return (
    <section style={{ display: "grid", gap: 18 }}>
      <SectionHeader
        title="Requirements"
        description="Capture the use case, environment, security direction, and operational context before detailed logical design work begins."
        actions={
          <>
            <button
              type="button"
      ...
      <div className="trust-note">
        ...
        <p className="muted" style={{ margin: "6px 0 0 0" }}>
          The goal is to make the network plan requirements-driven. Security, WAN style, environment type, and operational needs should shape the logical design before subnetting and validation become detailed work.
        </p>
      </div>
      ...
      <div className="trust-note">
        ...
        <p className="muted" style={{ margin: "6px 0 0 0" }}>
          This workspace is meant to reflect standards-informed planning habits: define requirements first, shape trust boundaries and addressing structure deliberately, then move into validation, diagrams, and handoff outputs.
        </p>
      </div>
        ...
        <section className="panel" style={{ display: "grid", gap: 14 }}>
          <div>
            ...
            <p className="muted" style={{ margin: 0 }}>
              This requirements workspace now branches based on the scenario. More detailed planning fields appear only when the earlier choices make them relevant.
            </p>
          </div>
      ...
      <div className="grid-2" style={{ alignItems: "start" }}>
        {scenario.security ? <div className="panel"><h3 style={{ marginTop: 0 }}>Security conditions active</h3><p className="muted" style={{ marginBottom: 0 }}>This scenario should drive stronger trust boundaries, segmentation, and access-policy assumptions.</p></div> : null}
        {scenario.cloud ? <div className="panel"><h3 style={{ marginTop: 0 }}>Cloud / hybrid conditions active</h3><p className="muted" style={{ marginBottom: 0 }}>This scenario should later drive connectivity, overlap, and identity-boundary planning between on-prem and cloud spaces.</p></div> : null}
        {scenario.wireless ? <div className="panel"><h3 style={{ marginTop: 0 }}>Wireless conditions active</h3><p className="muted" style={{ marginBottom: 0 }}>Wireless and guest decisions should influence SSIDs, DHCP behavior, access design, and the topology view.</p></div> : null}
        {scenario.resilience ? <div className="panel"><h3 style={{ marginTop: 0 }}>Resilience conditions active</h3><p className="muted" style={{ marginBottom: 0 }}>Dual ISP and availability expectations should later affect WAN, validation, and handoff recommendations.</p></div> : null}
      </div>
    </section>
  );
}
