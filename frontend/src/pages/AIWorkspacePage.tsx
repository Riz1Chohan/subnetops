...
export function AIWorkspacePage() {
  ...
  return (
    <section style={{ display: "grid", gap: 18 }}>
      <SectionHeader
        title="AI workspace"
        description="Use AI planning separately from the guided planner. Review the draft here, then carry the selected parts into Start Plan."
      />

      <section className="panel" style={{ display: "grid", gap: 12 }}>
        <h2 style={{ margin: 0 }}>How this workspace is used</h2>
        <p className="muted" style={{ margin: 0 }}>
          The AI workspace is kept separate so the guided planner can stay focused and structured. Generate a draft here, choose what to keep, and then continue in Start Plan.
        </p>
