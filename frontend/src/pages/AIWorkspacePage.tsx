...
export function AIWorkspacePage() {
  ...
  return (
    <section style={{ display: "grid", gap: 18 }}>
      <SectionHeader
        title="AI workspace"
        description="Use AI planning separately from the guided planner. PHASE19_AI_DRAFT_HELPER_CONTRACT keeps AI draft-only: review it here, then carry selected parts into Start Plan as review-required structured inputs."
      />
