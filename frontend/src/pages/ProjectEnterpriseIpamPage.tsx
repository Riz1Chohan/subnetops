    ...
    <section style={{ display: "grid", gap: 18 }}>
      ...
      <div className="panel" style={{ display: "grid", gap: 12 }}>
        ...
        <p className="muted" style={{ margin: 0 }}>
          Phase 59 exposes the backend PATCH routes directly in the UI. Edits still go through Engine 2 write-time guards, so overlapping pools, bad CIDRs, unsafe reservations, stale approvals, and brownfield conflicts are not silently accepted.
        </p>
      ...
      <div className="panel" style={{ display: "grid", gap: 12 }}>
        ...
        <p className="muted" style={{ margin: 0 }}>This compares saved brownfield current-state networks against durable allocations, DHCP scopes, IP pools, and allocator plan rows. Phase 58 adds durable conflict decisions, so review outcomes are no longer lost after refresh.</p>
