...
- Site authority notes now expose why the site is not yet fully authoritative.
...
- generating more explicit authoritative objects earlier instead of relying on late inference
